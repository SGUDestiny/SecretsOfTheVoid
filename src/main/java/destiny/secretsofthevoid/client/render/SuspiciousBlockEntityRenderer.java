...
public class SuspiciousBlockEntityRenderer<T extends SuspiciousBlockEntity> implements BlockEntityRenderer<T> {
    public final ItemRenderer itemRenderer;

    public SuspiciousBlockEntityRenderer(BlockEntityRendererProvider.Context pContext) {
        this.itemRenderer = pContext.getItemRenderer();
    }

    @Override
    public void render(SuspiciousBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
