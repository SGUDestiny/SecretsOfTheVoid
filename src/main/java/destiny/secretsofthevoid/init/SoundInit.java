...
public class SoundInit {
    ...
    public static RegistryObject<SoundEvent> DISK_HADAL = registerSoundEvent("disc/disc_hadal");

    public static RegistryObject<SoundEvent> DISK_HADAL_AMBIENT = registerSoundEvent("disc/disc_hadal_ambient");
