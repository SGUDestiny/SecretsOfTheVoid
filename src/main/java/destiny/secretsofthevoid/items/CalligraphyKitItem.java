...
public class CalligraphyKitItem extends Item
{
    public CalligraphyKitItem(Properties props)
    {
        super(props);
    }
    ...
    {
        tooltip.add(Component.translatable("tooltip.secretsofthevoid.calligraphy_kit_desc"));
    }
