...
public class SteelAirTankItem extends SteelGearItem implements IAirTank {


    public SteelAirTankItem(ArmorMaterial pMaterial, Type pType, Properties pProperties)
    {
