...
public class NetheriteMaskItem extends NetheriteGearItem implements IMask
{
    public NetheriteMaskItem(ArmorMaterial pMaterial, Type pType, Properties pProperties)
    {
