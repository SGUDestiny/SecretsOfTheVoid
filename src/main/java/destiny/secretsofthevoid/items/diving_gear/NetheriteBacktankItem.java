...
public class NetheriteBacktankItem extends NetheriteGearItem implements IBacktank
{


    public NetheriteBacktankItem(ArmorMaterial pMaterial, Type pType, Properties pProperties)
    {
    ...
    public void onCraftedBy(ItemStack stack, Level level, Player player) {
        if (stack.getTag() != null && stack.getTag().getDouble(MAX_OXYGEN) != 540) {
            stack.getOrCreateTag().putDouble(MAX_OXYGEN, 540);
            stack.getOrCreateTag().putDouble(STORED_OXYGEN, 540);
        }
    }
