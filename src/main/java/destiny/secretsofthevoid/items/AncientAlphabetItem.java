...
public class AncientAlphabetItem extends Item
{

    public AncientAlphabetItem(Properties properties)
    {
        super(properties);
    }
    ...
    {
        tooltip.add(Component.translatable("tooltip.secretsofthevoid.ancient_alphabet_desc"));
    }
}
