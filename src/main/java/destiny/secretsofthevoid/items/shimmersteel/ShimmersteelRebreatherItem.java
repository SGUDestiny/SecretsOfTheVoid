...
public class ShimmersteelRebreatherItem extends ShimmersteelGearItem implements IRebreather {
    public ShimmersteelRebreatherItem(ArmorMaterial pMaterial, Type pType, Properties pProperties)
    {
    ...
    public void onCraftedBy(ItemStack stack, Level level, Player player) {
        if (stack.getTag() != null && stack.getTag().getDouble(OXYGEN_EFFICIENCY) != 1.2) {
            stack.getOrCreateTag().putDouble(OXYGEN_EFFICIENCY, 1.2);
        }
    }
